...
directory = "/Users/stefa/Documents/Code/Voteview/"  # Definimos Workspace
os.chdir(directory)
...
# Helper function for voteview_search equivalent
def voteview_search(query, startdate, enddate):
    # Simulate the behavior of voteview_search by returning dummy data
    # You can use requests to query an actual API, or fetch local data files
    print(f"Searching for: {query} from {startdate} to {enddate}")
    return {"id": 1, "results": "Simulated results"}  # Replace with actual data fetching logic

# Helper function for voteview_download equivalent
def voteview_download(id):
    # Simulate downloading and return a dummy dataframe
...
# Simulate Rvoteview data search and download for periods of interest
...
# Simulating the Vietnam War period
print("tranqui tarda un poco, prepara el mate")
...
# Add party names and create graphs for Vietnam War period
...
# Simulating the Afghanistan invasion period
print("tranqui tarda un poco, prepara el mate")
...
# Add party names and create graphs for Afghanistan period
...
# Add party names and create graph for Government Management
